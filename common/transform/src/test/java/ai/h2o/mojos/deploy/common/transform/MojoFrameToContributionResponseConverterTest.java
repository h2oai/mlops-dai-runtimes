...
class MojoFrameToContributionResponseConverterTest {
  ...
  void convertEmptyRowsResponse_succeeds() {
    ...
    assertThat(result.getContributionOutputGroup().get(0).getContributions()).isEmpty();
    assertThat(result.getContributionOutputGroup().get(0).getOutputGroup()).isNull();
  ...
  void convertMoreTypesResponse_succeeds(String[][] contributions) {
    ...
    // Then
    assertThat(result.getContributionOutputGroup().size()).isEqualTo(1);
    assertThat(result.getContributionOutputGroup().get(0).getContributions())
  ...
  void convertSingleFeatureResponse_succeeds() {
    ...
    // Then
    assertThat(result.getContributionOutputGroup().size()).isEqualTo(1);
    assertThat(result.getContributionOutputGroup().get(0).getContributions().size()).isEqualTo(1);
    assertThat(result.getContributionOutputGroup().get(0).getContributions())
  ...
  void convertSingleFeatureResponse_withOneOutputGroup_succeeds() {
    ...
    assertThat(result.getContributionOutputGroup().get(0).getOutputGroup()).isEqualTo("test");
    assertThat(result.getFeatures()).containsExactly("feature");
  }
  ...
  void convertSingleFeatureResponse_withManyOutputGroup_succeeds() {
    ...
    assertThat(result.getContributionOutputGroup().get(0).getContributions())
            .containsExactly(asRow("122.2"));
    assertThat(result.getContributionOutputGroup().get(0).getOutputGroup()).isEqualTo("test1");

    assertThat(result.getContributionOutputGroup().get(1).getContributions().size()).isEqualTo(1);
    assertThat(result.getContributionOutputGroup().get(1).getContributions())
            .containsExactly(asRow("34.6"));
    assertThat(result.getContributionOutputGroup().get(1).getOutputGroup()).isEqualTo("test2");
  ...
  void convertSingleFeatureResponse_withManyRowsAndOutputGroups_succeeds() {
    ...
    assertThat(result.getContributionOutputGroup().get(0).getContributions().size()).isEqualTo(2);
    assertThat(result.getContributionOutputGroup().get(0).getContributions())
            .containsExactly(asRow("122.2"), asRow("90.2"));
    assertThat(result.getContributionOutputGroup().get(0).getOutputGroup()).isEqualTo("test1");

    assertThat(result.getContributionOutputGroup().get(1).getContributions().size()).isEqualTo(2);
    assertThat(result.getContributionOutputGroup().get(1).getContributions())
