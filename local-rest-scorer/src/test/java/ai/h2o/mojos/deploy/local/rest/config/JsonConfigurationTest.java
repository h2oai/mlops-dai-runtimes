...
class JsonConfigurationTest {
  ...
  @ParameterizedTest
  @MethodSource
  public void objectMapperShouldHandlesMixedValueRows(String givenRowJson, Row expRow) throws IOException {
    // When
  ...
  @ParameterizedTest
  @MethodSource
  public void defaultObjectMapperShouldFailOnNonNumericRows(String givenRowJson, Row expRow) throws IOException {
    // When & Then
    assertThrows(JsonMappingException.class, () -> defaultObjectMapper.readValue(givenRowJson, Row.class));
