...
project = u'Driverless AI Deployment Templates'
copyright = u'2019 H2O.ai.'
author = u'H2O'
...
if os.path.exists("VERSION.txt"):
    ...
    version = "Driverless AI Deployment Templates"
print("version is " + str(version))

#Version tied to build
...
exclude_patterns = [
    ...
    # Exclude directories should not yet be included.
    # Exclude directories that will be automatically pulled
    # in with the examples folder
...
# -- Configs for nbsphinx -------------------------------------------------
# This makes it possible to import jyputer notebook files into help system
...
latex_documents = [
    (master_doc, 'UsingDriverlessAI.tex', u'Using Driverless AI',
     u'H2O.ai', 'manual'),
]
...
# not chapters.
#latex_top_level_sectioning = False
